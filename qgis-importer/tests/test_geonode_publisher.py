...
from scripts.geonode_publisher import GeoNodeSynchronizer, QgsProcessingFeedback, QgsApplication, get_credentials
...
class MyTestCase(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.successful_request.status_code = 222
        self.successful_request.json = MagicMock(return_value={"a": 1})
    ...
    @patch("requests.post")
    @patch("scripts.geonode_publisher.get_credentials")
    def test_sut_processAlgorithm_should_produce_the_expected_output(self, mock_cred, mocked_post_request):
        ...
        mock_cred.return_value = {"username": "abc", "password": "cde"}
